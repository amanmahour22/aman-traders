        ...
        if ("undefined" == typeof WPD.dom.fn || "undefined" == typeof WPD.dom.fn.a) WPD.dom.fn = {
            ...
            extend: function() {
                for (let a = 1; a < arguments.length; a++)
                    for (let b in arguments[a]) arguments[a].hasOwnProperty(b) && (arguments[0][b] = arguments[a][b]);
                return arguments[0]
            },
            copy: function(a, b) {
                let c, d, e;
                ...
                c = new a.constructor;
                for (d in a) a.hasOwnProperty(d) && (e = typeof a[d], c[d] = b && "object" === e && null !== a[d] ? this.copy(a[d]) : a[d]);
                return c
            },
            parent: function(a) {
                let b =
                    ...
                    c = this.copy(this, !0);
                c.a = [];
                null != b && (b = b.parentElement, "undefined" != typeof a ? b.matches(a) && (c.a = [b]) : c.a = null == b ? [] : [b]);
                return c
            },
            first: function() {
            ...
            prev: function(a) {
                ...
                if ("undefined" == typeof a) b.a = "undefined" != typeof b.a[0] && null != b.a[0].previousElementSibling ? [b.a[0].previousElementSibling] : [];
            ...
            next: function(a) {
                let b = this.copy(this, !0);
                if ("undefined" == typeof a) b.a = "undefined" != typeof b.a[0] && null != b.a[0].nextElementSibling ? [b.a[0].nextElementSibling] : [];
                else if ("undefined" != typeof b.a[0]) {
            ...
            add: function(a) {
                if ("undefined" !== typeof a)
                    if ("undefined" !==
                        typeof a.nodeType) - 1 == this.a.indexOf(a) && this.a.push(a);
                ...
                if (null != b)
                    if (1 == arguments.length)
                        if ("select-multiple" == b.type) {
                            ...
                            for (let c = 0, d = b.options.length, e; c < d; c++) e = b.options[c], e.selected = -1 != a.indexOf(e.value)
                        } else b.value = a;
                else return "select-multiple" == b.type ? Array.prototype.map.call(b.selectedOptions, function(c) {
                    return c.value
                }) : b.value;
                return this
            },
            ...
            attr: function(a, b) {
                ...
                this.forEach(function(f) {
                    2 == d.length ? (f.setAttribute(a, b), c = e) : "object" === typeof a ? Object.keys(a).forEach(function(g) {
            ...
            data: function(a, b) {
                ...
                return null != c ? 2 == arguments.length ? (c.dataset[d] = b, this) : "undefined" == typeof c.dataset[d] ? "" : c.dataset[d] : ""
            },
            html: function(a) {
                let b = this.get(0);
                return null != b ? 1 == arguments.length ? (b.innerHTML = a, this) : b.innerHTML : ""
            },
            text: function(a) {
                let b = this.get(0);
                return null !=
            ...
            css: function(a, b) {
                ...
                for (let e = 0; e < c.length; e++)
                    if (d = c[e], 1 == arguments.length)
                        if ("object" == typeof a) Object.keys(a).forEach(function(f) {
                            d.style[f] = a[f]
                        });
            ...
            offset: function() {
                let a = this.get(0);
                return null != a ? WPD.dom._fn.hasFixedParent(a) ? a.getBoundingClientRect() :
            ...
            outerWidth: function(a) {
                a = a || !1;
                let b = this.get(0);
                if (null != b) return a ? parseInt(b.offsetWidth) + parseInt(this.css("marginLeft")) + parseInt(this.css("marginRight")) : parseInt(b.offsetWidth)
            },
            ...
            innerWidth: function() {
                var a = this.get(0);
                return null != a ? (a = window.getComputedStyle(a), this.outerWidth() - parseFloat(a.borderLeftWidth) -
            ...
            on: function() {
                let a = arguments,
                    b = function(d, e) {
                        ...
                        if ("mouseenter" == e.type || "mouseleave" == e.type || "hover" == e.type) {
                            ...
                            if (!g.matches(d[1]))
                                for (;
                                    (g = g.parentElement) && !g.matches(d[1]););
                            null != g && (f = WPD.dom(g))
                ...
                for (let d = 0; d < c.length; d++) {
                    let e = c[d];
                    if ("string" == typeof a[1]) this.forEach(function(f) {
                        ...
                        for (let f = 0; f < c.length; f++) {
                            ...
                            this.forEach(function(h) {
                                WPD.dom._fn.hasEventListener(h, g, a[1]) || (h.addEventListener(g,
                                    a[1], a[2]), h._wpd_el = "undefined" == typeof h._wpd_el ? [] : h._wpd_el, h._wpd_el.push({
                                    type: g,
                                    func: a[1],
                                    trigger: a[1],
                                    args: a[2]
            ...
            off: function(a, b) {
                this.forEach(function(c) {
                    if ("undefined" != typeof c._wpd_el && 0 < c._wpd_el.length)
                        if ("undefined" === typeof a) {
                            let d;
                            for (; d = c._wpd_el.pop();) c.removeEventListener(d.type, d.func, d.args);
                            c._wpd_el = []
                        } else a.split(" ").forEach(function(d) {
                            if ("undefined" == typeof b) {
                                let e;
                                for (; e = c._wpd_el.pop();) c.removeEventListener(d, e.func, e.args);
                                c._wpd_el = []
                            } else {
                                let e = [];
            ...
            trigger: function(a, b, c, d) {
                ...
                this.forEach(function(e) {
                    var f = !1;
                    d && "undefined" != typeof jQuery && "undefined" != typeof jQuery._data && "undefined" != typeof jQuery._data(e, "events") && "undefined" != typeof jQuery._data(e, "events")[a] &&
                        (jQuery(e).trigger(a, b), f = !0);
                    !f && c && (f = new Event(a), f.detail = b, e.dispatchEvent(f));
                    if ("undefined" != typeof e._wpd_el) e._wpd_el.forEach(function(g) {
                        if (g.type == a) {
                            let h = new Event(a);
                        ...
                        for (;;) {
                            ...
                            "undefined" != typeof h._wpd_el && h._wpd_el.forEach(function(k) {
                                if ("undefined" !== typeof k.selector) {
                                    ...
                                    0 < m.length && 0 <= m.get().indexOf(e) && k.type == a && (m = new Event(a), k.trigger.apply(e, [m].concat(b)),
                                        g = !0)
                                }
                            });
                            if (g) break
            ...
            clone: function() {
                let a = this.get(0);
                null != a ? (this.a = [a.cloneNode(!0)], this.length = this.a.length) : this.a = [];
            ...
            append: function(a) {
                ...
                this.forEach(function(b) {
                    a.forEach(function(c) {
                        null != c && ("undefined" !=
                            typeof c.is_wpd_dom ? c.forEach(function(d) {
                                b.appendChild(d)
            ...
            bodyTransform: function() {
                ...
                if ("undefined" !== typeof WebKitCSSMatrix) {
                    ...
                    "undefined" != typeof c.transform && (c = new WebKitCSSMatrix(c.transform), "undefined" != c.m41 && (a = c.m41),
            ...
            hasFixedParent: function(a) {
                ...
                do
                    if ("fixed" == window.getComputedStyle(a).position) return !0; while (a = a.parentElement);
                return !1
            },
            hasEventListener: function(a, b, c) {
                if ("undefined" == typeof a._wpd_el) return !1;
                for (let d = 0; d < a._wpd_el.length; d++)
                    if (a._wpd_el[d].trigger == c && a._wpd_el[d].type == b) return !0;
                return !1
            },
    ...
    WPD.dom.fn.animate = function(a, b, c) {
        ...
        this.forEach(function(e) {
            ...
            !1 === a ? n.forEach(function(l) {
                clearInterval(l)
            }) : (q = "undefined" != typeof d._animate.easing[c] ? d._animate.easing[c] :
                d._animate.easing.easeInOutQuad, Object.keys(a).forEach(function(l) {
                    -1 < l.indexOf("scroll") ? k[l] = e[l] : k[l] = parseInt(window.getComputedStyle(e)[l]);
                    m[l] = a[l] - k[l]
                }), f = b / 1E3 * 60, p = setInterval(function() {
                    g++;
                    g > f ? clearInterval(p) : (h = q(g / f), Object.keys(m).forEach(function(l) {
                        -1 < l.indexOf("scroll") ? e[l] = k[l] + m[l] * h : e.style[l] = k[l] + m[l] * h + "px"
                    }))
                }, 1E3 / 60), n.push(p), d.prop("_wpd_dom_animations", n))
        });
        return this
    };
    ...
    WPD.dom.fn.highlight = function(b, c) {
        function d(g, h, k, m, n) {
            ...
            if (3 === g.nodeType) {
                ...
                for (let p = 0; p < g.childNodes.length; p++) p += d(g.childNodes[p], h, k, m, n);
            return 0
        }
        let e = {
            className: "highlight",
    ...
    WPD.dom.fn.serialize = function() {
        ...
        if (a && "FORM" === a.nodeName) {
            ...
            for (b = a.elements.length - 1; 0 <= b; --b)
                if ("" !== a.elements[b].name) switch (a.elements[b].nodeName) {
                    case "INPUT":
                        switch (a.elements[b].type) {
                            ...
                            case "checkbox":
                            case "radio":
                                a.elements[b].checked && d.push(a.elements[b].name +
                    ...
                    case "SELECT":
                        switch (a.elements[b].type) {
                            ...
                            case "select-multiple":
                                for (c = a.elements[b].options.length - 1; 0 <= c; --c) a.elements[b].options[c].selected && d.push(a.elements[b].name + "=" + encodeURIComponent(a.elements[b].options[c].value))
                        }
                        break;
                    case "BUTTON":
                        switch (a.elements[b].type) {
...
(function() {
    ...
    WPD.dom.fn.inViewPort = function(a, b) {
        ...
        let f = e.bottom,
            ...
            h = e.right;
        null == b && (b = window);
        b === window ? (e = window.innerWidth || 0, d = window.innerHeight || 0) : (e = b.clientWidth, d = b.clientHeight, b = b.getBoundingClientRect(), c -= b.top, f -= b.top, g -= b.left, h -= b.left);
...
(function() {
    ...
    WPD.dom.fn.ajax = function(a) {
        ...
        } else return b = new XMLHttpRequest, b.onreadystatechange = function() {
        ...
        }, b.open(a.method.toUpperCase(), a.url, !0), b.setRequestHeader("Content-type", a.contentType), b.setRequestHeader("Accept", a.accept), b.send(this.serializeForAjax(a.data)), b
    };
...
window.WPD.Base64 = {
    ...
    _utf8_encode: function(a) {
        ...
        for (let c = 0; c < a.length; c++) {
            ...
            128 > d ? b += String.fromCharCode(d) : (127 < d && 2048 >
    ...
    _utf8_decode: function(a) {
        let b = "",
            c = 0,
            d, e, f;
        for (; c < a.length;) d = a.charCodeAt(c), 128 > d ? (b += String.fromCharCode(d), c++) : 191 < d && 224 > d ? (e = a.charCodeAt(c + 1), b += String.fromCharCode((d & 31) << 6 | e & 63), c += 2) : (e = a.charCodeAt(c + 1), f = a.charCodeAt(c + 2), b += String.fromCharCode((d & 15) << 12 | (e & 63) << 6 | f & 63), c += 3);
        return b
    }
};
(function() {
    ...
    a.applyFilters = function(b) {
        ...
        }), d.splice(0, 2), c.forEach(function(f) {
