        ...
        this.addons = {
            ...
            remove: function(d) {
                this.addons.filter(function(b) {
                    return b.name == d ? ("undefined" != typeof b.destroy && b.destroy(), !1) : !0
                })
            }
        }
    }
    ...
    d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
        liveLoad: function(a, c, f, e) {
            function l(h) {
                ...
                "" != h && 0 < q.length && 0 < q.find(a).length && (h = h.replace(/&asl_force_reset_pagination=1/gmi, ""), h = h.replace(/%26asl_force_reset_pagination%3D1/gmi, ""), h = h.replace(/&#038;asl_force_reset_pagination=1/gmi,
                    ...
                    }), g.addHighlightString(d(a).find("a")), b.Hooks.applyFilters("asl/live_load/finished", c, g, a, k.get(0)), ASL.initialize(), g.lastSuccesfulSearch = d("form", g.n("searchsettings")).serialize() + g.n("text").val().trim(), g.lastSearchData = h);
            ...
            e || 1 != g.n("searchsettings").find("input[name=filters_initial]").val() || "" != g.n("text").val() ? (g.searching = !0,
                g.post = d.fn.ajax({
                    ...
                    fail: function(h) {
                        k.css("opacity", 1);
                        h.aborted || (k.html("This request has failed. Please check your connection."), g.hideLoader(), g.searching = !1, g.n("proclose").css({
                            display: "block"
                        }))
                    }
        ...
        getCurrentLiveURL: function() {
            ...
            f = -1 < f.indexOf("asl_ls=") ?
                f.slice(0, f.indexOf("asl_ls=")) : f;
            f = -1 < f.indexOf("asl_ls&") ? f.slice(0, f.indexOf("asl_ls&")) : f;
            f = -1 < f.indexOf("p_asid=") ? f.slice(0, f.indexOf("p_asid=")) : f;
            f = -1 < f.indexOf("asl_") ? f.slice(0, f.indexOf("asl_")) : f; - 1 === f.indexOf("?") && (c = "?");
...
(function(d) {
    d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
        loadASLFonts: function() {
            ...
            }).catch(function(b) {}), ASL.font_url = !1)
        },
        updateHref: function() {
        ...
        fixClonedSelf: function() {
            ...
            b != this.o.iid && (this.o.rid = this.o.id + "_" + this.o.iid, this.n("search").get(0).id = "ajaxsearchlite" + this.o.rid, this.n("search").removeClass("asl_m_" + a).addClass("asl_m_" + this.o.rid).data("instance", this.o.iid), this.n("searchsettings").get(0).id =
...
(function(d) {
    ...
    d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
        ...
        getRedirectURL: function(a) {
            ...
            "results_page" == a || "ajax_search" == a ? a = "?s=" + b.nicePhrase(this.n("text").val()) : "woo_results_page" == a ? a = "?post_type=product&s=" + b.nicePhrase(this.n("text").val()) :
                (a = this.o.trigger.redirect_url, a = a.replace(/{phrase}/g, b.nicePhrase(this.n("text").val())));
            1 < this.o.homeurl.indexOf("?") && 0 === a.indexOf("?") && (a = a.replace("?", "&"));
            if (this.o.overridewpdefault && "post" != this.o.override_method) {
                let c = "&"; - 1 === this.o.homeurl.indexOf("?") && -1 === a.indexOf("?") && (c = "?");
...
(function(d) {
    ...
    d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
        ...
        searchWithCheck: function(a) {
            ...
            c.n("text").val().length < c.o.charcount || (c.searchAbort(), clearTimeout(c.timeouts.searchWithCheck), c.timeouts.searchWithCheck = setTimeout(function() {
                c.search()
            }, a))
        },
        search: function() {
            ...
            if (!(a.n("text").val().length < a.o.charcount)) {
                ...
                0 < d(".asl_es_" + a.o.id).length ?
                    a.liveLoad(".asl_es_" + a.o.id, a.getCurrentLiveURL(), !1) : a.o.resPage.useAjax ? a.liveLoad(a.o.resPage.selector, a.getRedirectURL()) : a.post = d.fn.ajax({
                        url: ASL.ajaxurl,
                        method: "POST",
                        data: c,
                        success: function(e) {
                            ...
                            a.showResults();
                            a.scrollToResults();
                            a.lastSuccesfulSearch = d("form", a.n("searchsettings")).serialize() +
                                a.n("text").val().trim();
                            a.lastSearchData = c;
                            a.updateHref();
                            0 == a.n("items").length ? null != a.n("showmore") && a.n("showmore").css("display", "none") : null != a.n("showmore") && (a.n("showmore").css("display", "block"), d("span", a.n("showmore")).off(), d("span", a.n("showmore")).on("click", function() {
...
(function(d) {
    d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
        ...
        closeResults: function(b) {
            "undefined" != typeof b && b && (this.n("text").val(""), this.n("textAutocomplete").val(""));
            this.hideResults();
            this.n("proloading").css("display",
                "none");
            this.hideLoader();
            this.searchAbort()
        },
...
(function(d) {
    d.fn.extend(window.WPD.ajaxsearchlite.helpers, {
        ...
        whichjQuery: function(b) {
            ...
            !1 === a && "undefined" != typeof window.jQuery && (a = window.jQuery, "undefined" === typeof b ? a = window.jQuery : "undefined" != typeof window.jQuery.fn[b] && (a = window.jQuery));
            return a
        },
        formData: function(b,
            a) {
            ...
            if (1 === arguments.length) return a = {}, f.forEach(function(e) {
                e.name && !e.disabled && (e.checked || /select|textarea/i.test(e.nodeName) || /text/i.test(e.type) || d(e).hasClass("hasDatepicker") || d(e).hasClass("asl_slider_hidden")) && (void 0 == a[e.name] && (a[e.name] = []), d(e).hasClass("hasDatepicker") ? a[e.name].push(d(e).parent().find(".asl_datepicker_hidden").val()) : a[e.name].push(d(e).val()))
            }), JSON.stringify(a);
                ...
                if (e.name)
                    if (a[e.name]) {
                        ...
                        if ("checkbox" == e.type || "radio" == e.type) {
                            ...
                            m.prop("checked", g)
                        } else m.val(l[0]), (d(e).hasClass("asl_gochosen") || d(e).hasClass("asl_goselect2")) && WPD.intervalUntilExecute(function(k) {
                            k(e).trigger("change.asl_select2")
                        }, function() {
                            return c.whichjQuery("asl_select2")
                        }, 50, 3), d(e).hasClass("hasDatepicker") && WPD.intervalUntilExecute(function(k) {
                            let g = l[0],
                                h = k(m.get(0)).datepicker("option",
                                    "dateFormat");
        ...
        getWidthFromCSSValue: function(b, a) {
            b += "";
            b = -1 < b.indexOf("px") ? parseInt(b, 10) : -1 < b.indexOf("%") ? "undefined" != typeof a && null != a ? Math.floor(parseInt(b,
                10) / 100 * a) : parseInt(b, 10) : parseInt(b, 10);
            return 100 > b ? 100 : b
        },
        ...
        decodeHTMLEntities: function(b) {
            ...
            b && "string" === typeof b && (b = b.replace(/<script[^>]*>([\S\s]*?)<\/script>/gmi, ""), b = b.replace(/<\/?\w(?:[^"'>]|"[^"]*"|'[^']*')*>/gmi, ""), a.innerHTML = b, b = a.textContent, a.textContent = "");
            return b
        },
...
(function(d) {
    ...
    d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
        detectAndFixFixedPositioning: function() {
            ...
            for (; c;)
                if (c = c.parentElement, null != c && "fixed" == window.getComputedStyle(c).position) {
                    a = !0;
                    break
                }
        ...
        fixResultsPosition: function(a) {
            ...
            if (0 != d._fn.bodyTransformY() || "static" != c.css("position")) f = c.offset().top;
            0 != d._fn.bodyTransformY() && "fixed" == e && (e = "absolute", this.n("resultsDiv").css("position", "absolute"));
            "fixed" == e && (f = 0);
            if ("fixed" ==
                e || "absolute" == e)
                if (1 == a || "visible" == this.n("resultsDiv").css("visibility")) {
                    ...
                    e = 0;
                    if (0 != d._fn.bodyTransformX() || "static" != c.css("position")) e = c.offset().left;
                    if ("undefined" != typeof a) {
                        ...
                        "right" == this.o.resultsSnapTo ?
                            l = this.n("resultsDiv").outerWidth() - this.n("search").outerWidth() : "center" == this.o.resultsSnapTo && (l = Math.floor((this.n("resultsDiv").outerWidth() - parseInt(this.n("search").outerWidth())) / 2));
                        this.n("resultsDiv").css({
        ...
        fixSettingsPosition: function(a) {
            ...
            0 != d._fn.bodyTransformY() &&
                "fixed" == e && (e = "absolute", this.n("searchsettings").css("position", "absolute"));
            "fixed" == e && (f = 0);
            if (1 == a || 0 != this.n("prosettings").data("opened")) {
                a = 0;
                if (0 != d._fn.bodyTransformX() || "static" != c.css("position")) a = c.offset().left;
    ...
    d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
        initMagnifierEvents: function() {
            ...
            b.n("promagnifier").on("click", function(a) {
                ...
                if (b.n("text").val().length >= b.o.charcount && 1 == b.o.redirectOnClick && "first_result" != b.o.trigger.click) return b.doRedirectToResults("click"), clearTimeout(void 0), !1;
                if ("ajax_search" != b.o.trigger.click && "first_result" != b.o.trigger.click) return !1;
                b.searchAbort();
    ...
    d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
        ...
        _initFocusInput: function() {
            ...
            a.n("text").on("click", function(c) {
                ...
                if (d("form", a.n("searchsettings")).serialize() + a.n("text").val().trim() == a.lastSuccesfulSearch) return a.resultsOpened || a.usingLiveLoader || (a._no_animations = !0, a.showResults(), a._no_animations = !1), !1
            });
                ...
                a = function(c) {
                    ...
                    if (0 < d(".item", b.n("resultsDiv")).length && "none" != b.n("resultsDiv").css("display") && "vertical" == b.o.resultstype) {
                        if (40 == f || 38 == f) {
                            ...
                            0 == e.length ? b.n("resultsDiv").find(".item").first().addClass("hovered") : (40 == f && (0 == e.next(".item").length ? b.n("resultsDiv").find(".item").removeClass("hovered").first().addClass("hovered") :
                                e.removeClass("hovered").next(".item").addClass("hovered")), 38 == f && (0 == e.prev(".item").length ? b.n("resultsDiv").find(".item").removeClass("hovered").last().addClass("hovered") : e.removeClass("hovered").prev(".item").addClass("hovered")));
                            c.stopPropagation();
                            c.preventDefault();
                            b.n("resultsDiv").find(".resdrg .item.hovered").inViewPort(50, b.n("resultsDiv").get(0)) || (e = b.n("resultsDiv").find(".resdrg .item.hovered").get(0), null != e && "undefined" != typeof e.scrollIntoView && e.scrollIntoView({
                                behavior: "smooth",
                                block: "start",
                                inline: "nearest"
                            }))
...
(function(d) {
    ...
    d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
        initOtherEvents: function() {
            let a = this;
            if (b.isMobile() && b.detectIOS()) a.n("text").on("touchstart", function() {
            ...
            a.n("proclose").on(a.clickTouchend, function(f) {
                ...
                a.n("proloading").css("display",
                    "none");
                a.hideLoader();
                a.searchAbort();
                0 < d(".asl_es_" + a.o.id).length ? (a.showLoader(), a.liveLoad(".asl_es_" + a.o.id, a.getCurrentLiveURL(), !1)) : a.o.resPage.useAjax && (a.showLoader(), a.liveLoad(a.o.resPage.selector, a.getRedirectURL()));
            ...
            if (b.isMobile() && "" != a.o.mobile.menu_selector) d(a.o.mobile.menu_selector).on("touchend", function() {
                let f = this;
                setTimeout(function() {
    ...
    d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
        initResultsEvents: function() {
            ...
            let a = function(c) {
                let f = c.keyCode || c.which,
                    e = c.type;
                0 == d(c.target).closest(".asl_w").length && (b.hideOnInvisibleBox(), "click" == e && "touchend" == e && 3 == f || 0 == b.resultsOpened || 1 != b.o.closeOnDocClick || b.dragging || (b.hideLoader(), b.searchAbort(), b.hideResults()))
            };
            b.documentEventHandlers.push({
                node: document,
...
(function(d) {
    d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
        initAutop: function() {
            ...
            window.WPD.intervalUntilExecute(function() {
                b.isAutoP = !0;
                "phrase" == b.o.autop.state ? (b.o.is_results_page || b.n("text").val(b.o.autop.phrase), b.search(c)) : "latest" == b.o.autop.state ? b.search(c, 1) : b.search(c, 2)
            }, function() {
    ...
    d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
        ...
        n: function(c) {
            if ("undefined" === typeof this.nodes[c]) switch (c) {
                ...
                case "container":
                    this.nodes[c] =
                        this.nodes.search.closest(".asl_w_container");
                    break;
                case "searchsettings":
...
(function(d) {
    ...
    d.fn.extend(window.WPD.ajaxsearchlite.plugin, {
        ...
        initResultsBox: function() {
            ...
            b.isMobile() && 1 == this.o.mobile.force_res_hover ? (this.o.resultsposition = "hover", this.nodes.resultsDiv = this.n("resultsDiv").clone(), d("body").append(this.nodes.resultsDiv), this.nodes.resultsDiv.css({
                    position: "absolute"
                }),
                this.detectAndFixFixedPositioning()) : "hover" == this.o.resultsposition && 0 >= this.n("resultsAppend").length ? (this.nodes.resultsDiv = this.n("resultsDiv").clone(), d("body").append(this.n("resultsDiv"))) : (this.o.resultsposition = "block", this.n("resultsDiv").css({
                position: "static"
            }), 0 < this.n("resultsAppend").length && (0 < this.n("resultsAppend").find(".asl_w").length ? this.nodes.resultsDiv = this.n("resultsAppend").find(".asl_w") : (this.nodes.resultsDiv = this.n("resultsDiv").clone(), this.nodes.resultsAppend.append(this.n("resultsDiv")))));
...
window.ASL.api = function() {
    let d = function(c, f, e, l) {
        ...
        b = function(c, f, e) {
            if (!isNaN(parseFloat(f)) && isFinite(f)) return c = ASL.instances.get(c, f), !1 !== c && c[e].apply(c);
    ...
    if (3 == arguments.length) return b.apply(this,
        arguments);
