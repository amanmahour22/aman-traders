(function(c) {
    c.fn.extend(window.WPD.ajaxsearchlite.plugin, {
        autocompleteGoogleOnly: function() {
            let a = this,
                d = a.n("text").val();
            if ("" == a.n("text").val()) a.n("textAutocomplete").val("");
            else {
                ...
                if ("" == e || 0 != e.indexOf(d)) {
                    ...
                    a.n("text").val().length >= a.o.autocomplete.trigger_charcount && c.fn.ajax({
                        ...
                        success: function(b) {
                            0 < b[1].length && (b = b[1][0][0].replace(/(<([^>]+)>)/ig, ""), b = c("<textarea />").html(b).text(), b = b.substr(d.length), a.n("textAutocomplete").val(d + b), a.fixAutocompleteScrollLeft())
                        }
                    })
                }
            }
    ...
    c.fn.extend(window.WPD.ajaxsearchlite.plugin, {
        initAutocompleteEvent: function() {
            ...
            1 == a.o.autocomplete.enabled && (a.n("text").on("keyup", function(d) {
                ...
                a.keycode == e && "" != a.n("textAutocomplete").val() ? (d.preventDefault(), a.n("text").val(a.n("textAutocomplete").val()), null != a.post && a.post.abort(), a.search()) : (null != a.postAuto && a.postAuto.abort(), a.autocompleteGoogleOnly())
            }), a.n("text").on("keyup mouseup input blur select",
                function() {
